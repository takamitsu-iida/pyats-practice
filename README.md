...
装置の再起動とか、インタフェースのダウン・アップ試験とか、とにかく作業に時間がかかる、やりたくない
めんどうなので省略したら裏目に出てそこがバグってた
装置内のファイルやコンフィグを外部に転送したいけどサーバがない
IOSのバージョンアップをしたいけどTFTPサーバがない

誰でもできる作業だけど、環境や手順を教えるのが面倒で結局いつも自分がやってしまってる
　モック使ったら解決

一子相伝で伝わってるよくわからないshowコマンドをよくわからないまま採取してる
　ログの見るべき場所がたくさんありすぎる、もしくはどこをみていいか分からない、判断ができない
　ログ取りしても、現場では見る時間がない
　ログファイルの整理整頓が大変、別の場所に移動するのが大変
　　TeraTERMだと一つのファイルにまとめてログにする、ができないからたくさんのファイルになりがち

teratermを立ち上げすぎてどれがどれだか分からない
　うっかり違うターミナルにコマンドいれてしまった

作業前後の差分がよくわからない、間違ってても気づかない
過去のログが流れてしまっていて、調べようにもどうにもならない
作業している人しか状況がわからないので複数の人が立ち会っても意味がない
...
ここで列挙したことは、だいたい解決できると思ってください

pyATSとは
・製品出荷前に品証部門が検証するときに使うツール
・TACが障害検証するときに使うツール
