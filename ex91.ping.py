...
def ping(dev, destination, source='loopback0', repeat=10000, duration=10):
    """
    ...
    # 出力される応答は別途取得する
    try:
        dev.sendline(f'ping {destination} source {source} repeat {repeat}')
